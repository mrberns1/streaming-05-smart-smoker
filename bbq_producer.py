...
def send_message(host: str('localhost'), queue_name: str ('missybbq'), message: str('producing')):
    """
...
try:
    ...
    ch.queue_declare(queue='missybbq', durable=True)
    # use the channel to publish a message to the queue
    # every message passes through an exchange
    ch.basic_publish(exchange="", routing_key='missybbq', body=MESSAGE)
...
if __name__ == "__main__":  
    ...
    send_message(host,'missybbq',message)
